module github.com/yorinasub17/packer-plugin-git-shell
...
require (
	...
	github.com/stretchr/testify v1.7.2-0.20220513111209-285adcc5ced0
...
// Force particular version of yaml.v3
