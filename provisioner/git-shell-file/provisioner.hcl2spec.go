...
type FlatConfig struct {
	...
	Files               []common.FlatFile `mapstructure:"file" cty:"file" hcl:"file"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"file":                       &hcldec.BlockListSpec{TypeName: "file", Nested: hcldec.ObjectSpec((*common.FlatFile)(nil).HCL2Spec())},
	}
	return s
}
